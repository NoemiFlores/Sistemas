...
<body>
	...
	<form action="<?php echo base_url();?>Formulario/actualizarNoticia" method="post">
	...
	<div class="row" style="/*border: 5px solid red"> <!--con el row secciona el elemento, indicando que es un renglon --> 
		<div class="col-25" style="/*border: 5px solid blue*/">
			<label for="ltitulo" class="color_labels">Id:</label>
		</div>

		<div class="col-75" style="/*border: 5px solid cyan">
			<input type="text" name="iid" id="iid" maxLenght="50" placeholder="Id" readonly value="<?php echo $noticia->idnoticia?>">
		</div>
	</div>
	...
	<div class="row" style="/*border: 5px solid red"> <!--con el row secciona el elemento, indicando que es un renglon --> 
		...
		<div class="col-75" style="/*border: 5px solid cyan">
			<input type="text" name="ititulo" id="ititulo" maxLenght="50" placeholder="Titulo de la noticia" value="<?php echo $noticia->titulo?>" required>
		</div>
	</div>
	...
	<div class="row" style="/*border: 5px solid red"> <!--con el row secciona el elemento, indicando que es un renglon --> 
		...
		<div class="col-75" style="/*border: 5px solid cyan">
			<input type="text" name="itexto" id="itexto" maxLenght="50" placeholder="Escriba su noticia" value="<?php echo $noticia->texto?>" required>
		</div>
	</div>
    ...
    <div class="row" style="/*border: 5px solid red"> <!--con el row secciona el elemento, indicando que es un renglon --> 
		...
		<div class="col-75" style="/*border: 5px solid cyan">
			<input type="date" name="ifecha" id="ifecha" placeholder="Fecha de la noticia" value="<?php echo $noticia->fecha?>" required>
		</div>
	</div>
	...
	<div class="row" style="/*border: 5px solid red"> <!--con el row secciona el elemento, indicando que es un renglon -->
		<div class="col-25" style="/*border: 5px solid cyan">
			...
			<input type="submit" name="actualizar" id="boton" value="Actualizar"></label>
		</div>
	</div>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-footer">
							...
							<button type="button" class="btn btn-danger" onclick="location.href='<?php echo base_url();?>Formulario/mostrarNoticias'">Si</button>
						</div>
					</div>
				</div>
			</div>
